...
Follow previous attempt 5 strategies, use Gradient Boost Classifier 
...
model = GradientBoostingClassifier(n_estimators=50, min_samples_leaf=3, min_samples_split=10, max_features='sqrt', max_depth=6)
model.fit(X_train,y_train)
reducedScore = model.score(X_train,y_train) # = 0.8485
...
output.to_csv("7_GradBoost.csv", index=False)
